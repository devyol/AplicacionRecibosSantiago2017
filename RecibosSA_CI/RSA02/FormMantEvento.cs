...
namespace RSA02
{
    public partial class frmMantEvento : Form
    {
        ...
        private void cargarGridEventos()
        {
            ...
            Mensaje<List<REC01_EVENTO>> resp = list.listarTodosEventos();
        ...
        private void obtenerUnEvento(REC01_EVENTO ev)
        {
            Evento obj = new Evento();
            Mensaje<REC01_EVENTO> resp = obj.obtenerEvento(ev);
        ...
        private void descripcionEstado()
        {
            ...
            Mensaje<List<REC01_ESTADO>> resp = lis.listaDescripcionEstadoEvento();
